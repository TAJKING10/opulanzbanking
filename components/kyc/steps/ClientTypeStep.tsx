  ...
  return (
    <div>
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-brand-dark mb-2">Welcome to Opulanz</h2>
        <p className="text-brand-grayMed">Let's start your investment journey</p>
      </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <h3 className="font-semibold text-brand-dark mb-1">Individual</h3>
              <p className="text-sm text-brand-grayMed">Personal investment account</p>
            </button>
            ...
            >
              ...
              <h3 className="font-semibold text-brand-dark mb-1">Company</h3>
              <p className="text-sm text-brand-grayMed">Corporate investment account</p>
            </button>
          </div>
        </div>
