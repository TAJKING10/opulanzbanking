...
function LifeInsuranceConfirmationPageContent({ locale }: { locale: string }) {
  ...
  const bookingData = React.useMemo(() => {
    if (typeof window !== "undefined") {
      ...
      const stored = sessionStorage.getItem("life-insurance-booking");
      if (stored) {
        try {
...
<body>
  ...
  <div class="section">
    ...
    <div class="detail-row">
      ...
      <span class="detail-value">${bookingData.serviceTitle || 'Life Insurance Consultation'}</span>
    </div>
    <div class="detail-row">
  ...
  const handleAddToCalendar = () => {
    ...
    calendarUrl.searchParams.set("details", `Life insurance consultation with Opulanz Banking.\n\nService: ${bookingData.serviceTitle}\nConfirmation: ${confirmationNumber}`);
...
export default function ConfirmationPage({ params: { locale } }: { params: { locale: string } }) {
  return (
    <SearchParamsWrapper>
      <LifeInsuranceConfirmationPageContent locale={locale} />
    </SearchParamsWrapper>
  );
}
